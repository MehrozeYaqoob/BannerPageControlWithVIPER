package com.example.haidermirza.banner.library;
...
public abstract class RecyclerViewBannerBase<L extends RecyclerView.LayoutManager, A extends RecyclerView.Adapter> extends FrameLayout {
    ...
    protected int autoPlayDuration = 4000;//Refresh interval

    protected boolean showIndicator;//Whether to display the indicator
    ...
    protected int indicatorMargin;//Indicator spacing
    ...
    protected List<Banner> tempUrlList = new ArrayList<>();
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        if (mSelectedDrawable == null) {
            //Drawing the default selected state graphic
        ...
        if (mUnselectedDrawable == null) {
            //Drawing default unselected state graphics
    ...
    protected abstract A getAdapter(Context context, List<Banner> list, OnBannerItemClickListener onBannerItemClickListener);

    /**
           * Set the rotation interval
           *
           * @param millisecond time milliseconds
           */
    ...
    /**
     * Set up a carousel data set
     */
    public void initBannerImageView(@NonNull List<Banner> newList, OnBannerItemClickListener onBannerItemClickListener) {
        //Solve the recyclerView nesting problem
     ...
     * Set up a carousel data set
     */
    public void initBannerImageView(@NonNull List<Banner> newList) {
    ...
    protected boolean compareListDifferent(List<Banner> newTabList, List<Banner> oldTabList) {
