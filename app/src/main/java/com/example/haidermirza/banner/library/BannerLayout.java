...
import com.example.haidermirza.banner.library.layoutmanager.BannerLayoutManager;
import com.example.haidermirza.banner.library.layoutmanager.CenterSnapHelper;
...
public class BannerLayout extends FrameLayout {
    ...
    private boolean showIndicator;//Whether to display the indicator
